...
1.    python keras_to_tensorflow.py 
        --input_model="path/to/keras/model.h5" 
...
2. toco --graph_def_file=model.pb --input_format=TENSORFLOW_GRAPHDEF --output_format=TFLITE --output_file=model.tflite --inference_type=FLOAT --input_type=FLOAT --input_arrays=conv2d_9_input --output_arrays=activation_18/Softmax 
